...
const stripe = require('stripe')('sk_test_51Kt7xOJcK2M06qtxeavzAgMPPg6febKcv6qmA1T4Ugeu8EYS36UbAr97JI7yzCGaq5a0BXIvKnfQQwuAQdBymzaj00tdLmxHvx');

app.use(cors());
app.use(bodyParser.urlencoded({ extended: true }));
app.use(bodyParser.json());
app.get("/", (req, res) => {
    res.send("<h1>Chào tất cả các bạn đến với api DaNang Travel !</h1>");
}
)
